...
We will use the data the MN niceride system. I put the data in a package so it's easy to use. You can install it by typing `install_github("katiejolly/metcouncilR")` in your console.
